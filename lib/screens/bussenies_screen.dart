...
class BusseniesScreen extends StatefulWidget {
  final String title;
  final MaterialAccentColor color;
  
  const BusseniesScreen({super.key, required this.title, required this.color});

  @override
  State<BusseniesScreen> createState() => _BusseniesScreenState();
}

class _BusseniesScreenState extends State<BusseniesScreen> {
  late Future<List<dynamic>> newsArticles;

  @override
  void initState() {
    super.initState();
    newsArticles = NewsService().fetchNews('business');
  }
