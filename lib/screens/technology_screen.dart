...
class TechnologyScreen extends StatefulWidget {
  ...
  const TechnologyScreen({super.key, required this.title, required this.color});
...
class _TechnologyScreenState extends State<TechnologyScreen> {
  ...
  void initState() {
    super.initState();
    // Fetching news articles on initialization
    newsArticles = NewsService().fetchNews('technology');
  }
